...
public class ValuesQuery extends Query {
	...
	public ValuesQuery(Query query, Object value, Object... values) throws SQLException {
		super(query);
	...
	/**
	 * Set the values of the prepared statement. This allows the built
	 * query object to be reused.
	 * 
	 * @param values
	 * @throws SQLException
	 */
