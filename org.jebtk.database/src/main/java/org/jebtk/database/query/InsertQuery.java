...
public class InsertQuery extends ColumnsQuery {
	...
	public ValuesQuery values(Object value, Object... values) throws SQLException {
	...
	public void getSql(StringBuilder buffer) {
		...
		buffer.append(TextUtils.repeat("?", TextUtils.FORMATTED_LIST_DELIMITER, mColumns.size()));
